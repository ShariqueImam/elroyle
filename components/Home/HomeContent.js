...
const style = {
  wrapper: 'h-[90%] flex items-center justify-around w-[95%] md:w-[80%] mx-auto',
  content: 'h-[80%] lg:h-[70%] my-auto flex flex-col w-full items-center justify-around',
  heading: ' text-6xl sm:text-6xl md:text-8xl lg:text-8xl text-[#F2ECDE] text-center',
  smallHeading:' text-center text-3xl sm:text-3xl md:text-4xl lg:text-6xl text-[#F2ECDE]',
