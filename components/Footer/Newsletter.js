...
const style = {
    ...
    input: 'placeholder:text-stone-300 px-2 py-3 rounded bg-transparent focus:ring-transparent outline-none border-none',
}
const Newsletter = () => {
    return (
        ...
        >
            ...
            <button aria-label="Icon to subscribe the newsletter"><AiOutlineMail className="text-gray-100 text-2xl" /></button>
            {/* <div></div> */}
        </form>
    )
}
