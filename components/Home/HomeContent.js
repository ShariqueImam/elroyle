...
const style = {
  ...
  content: 'h-[80%] sm:h-[60%] md:h-[70%] lg:h-[70%] my-auto flex flex-col w-full items-center justify-around',
  heading: ' text-6xl sm:text-8xl md:text-8xl lg:text-8xl text-[#F2ECDE] text-center',
  smallHeading:' my-4 sm:my-6 my:my-2 text-center text-3xl sm:text-3xl md:text-4xl lg:text-6xl text-[#F2ECDE]',
